...
public class PagamentoCanceladoQueueOUTAdapterGateway implements IPagamentoCanceladoQueueOUT {
    ...
    public PagamentoCanceladoQueueOUTAdapterGateway(RabbitTemplate rabbitTemplate, IJsonConverter jsonConverter) {
    ...
    public void publish(Pagamento pagamento) throws JsonProcessingException {
        ...
        logger.info("Publicado na fila de pagamentos cancelados!");
    }
}
